...
const styles = StyleSheet.create({
  ...
  sharePlanPermOptionRowActive: {
    borderColor: 'rgba(247,223,160,0.75)',
    backgroundColor: 'rgba(206,17,38,0.22)',
  },
  sharePlanPermCheckbox: {
    width: 22,
    height: 22,
    borderRadius: 6,
    borderWidth: 2,
  ...
  sharePlanPermCheckboxChecked: {
    borderColor: '#F7DFA0',
    backgroundColor: themeColors.primary,
  },
  sharePlanPermOptionTextCol: {
    flex: 1,
    minWidth: 0,
  },
  sharePlanPermOptionLabel: {
    fontSize: 15,
    fontFamily: FONT_POPPINS_BOLD,
    color: '#FFFFFF',
    letterSpacing: 0.1,
  },
  sharePlanPermOptionHint: {
    marginTop: 3,
    fontSize: 12,
    fontFamily: FONT_POPPINS_SEMIBOLD,
  ...
  sharePlanPermOptionRowLightActive: {
    borderColor: themeColors.primary,
    backgroundColor: `${themeColors.primary}10`,
  },
  sharePlanPermCheckboxLight: {
    width: 22,
    height: 22,
    borderRadius: 6,
    borderWidth: 2,
  ...
  sharePlanPermCheckboxLightChecked: {
    borderColor: themeColors.primary,
    backgroundColor: themeColors.primary,
  },
  sharePlanPermOptionLabelLight: {
    fontSize: 15,
    fontFamily: FONT_POPPINS_BOLD,
    color: '#0F172A',
  },
  sharePlanPermOptionHintLight: {
    marginTop: 3,
    fontSize: 12,
    fontFamily: FONT_POPPINS_SEMIBOLD,
    color: '#64748B',
