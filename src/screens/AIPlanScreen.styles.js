...
const styles = StyleSheet.create({
  ...
  orbitPlaceUnifiedCard: {
    ...
    overflow: 'hidden',
    borderWidth: 1,
    borderColor: 'rgba(233, 200, 119, 0.26)',
    paddingBottom: 4,
    ...Platform.select({
      ios: {
  ...
  orbitPlaceQuickActionBtn: {
    ...
    borderRadius: 10,
    borderWidth: 1,
    borderColor: 'rgba(247,223,160,0.3)',
    backgroundColor: 'rgba(15,23,42,0.54)',
    paddingVertical: 8,
    paddingHorizontal: 8,
  },
  orbitPlaceQuickActionLabel: {
    fontSize: 13,
    fontWeight: '700',
    color: '#F7DFA0',
    letterSpacing: 0.2,
  ...
  orbitPlaceCardCTA: {
    ...
    overflow: 'hidden',
    ...Platform.select({
      ios: { shadowColor: '#CE1126', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.35, shadowRadius: 10 },
      android: { elevation: 5 },
    }),
  },
  ...
  orbitPlaceSecondaryCTA: {
    ...
    borderRadius: 10,
    borderWidth: 1,
    borderColor: 'rgba(206,17,38,0.42)',
    backgroundColor: 'rgba(206,17,38,0.16)',
    overflow: 'hidden',
  },
